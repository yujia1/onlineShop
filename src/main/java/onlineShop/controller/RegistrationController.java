...
public class RegistrationController {
    ...
    public ModelAndView getRegistrationForm() {
        ...
        // 为什么ModelAndView能返回register网页,路径在哪设置
        return new ModelAndView("register", "customer", customer); // 用户拿到登陆页面
    }

    @RequestMapping(value = "/customer/registration", method = RequestMethod.POST) // 用户提交表单
