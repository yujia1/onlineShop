...
public class ApplicationConfig {
    ...
    public DataSource dataSource() {
        ...
        // 只需要修改红色部分, 保留其他内容
        dataSource.setUrl("jdbc:mysql://twitchproject.c6teopct2idb.us-east-2.rds.amazonaws.com:3306/ecommerce1?createDatabaseIfNotExist=true&serverTimezone=UTC");
        dataSource.setUsername("admin");
        dataSource.setPassword("Jiayu600.");
        return dataSource;
    }
